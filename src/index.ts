...
function addOnVolumeChangeListener(listener: (event: OnVolumeChangePayload) => void): Subscription {
  return emitter.addListener<OnVolumeChangePayload>('onVolumeChange', listener);
}

ReactNativeMicrophoneMeter.addOnVolumeChangeListener =  addOnVolumeChangeListener
