...
import Animated, { interpolate, useAnimatedStyle, useSharedValue, withTiming, interpolateColor } from 'react-native-reanimated';
...
export default function App() {
  ...
  const startMonitoringAudio = () => {
    try {
      audioListener.current = ReactNativeMicrophoneMeter.addOnVolumeChangeListener(({ db }) => {
